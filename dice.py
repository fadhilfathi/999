...
def dice(ws,ls):
   ...
   limit_a = int(float(obj["Config"][urut]["Reset If Win"])) - 1
   ...
   try:
     ...
     while True:
       ...
       print ("")
       sys.exit()
r = c.get(url,headers=ua,data={"a": "Login","Key": "ecebe4db5ae04e4490af75c19d4bdff0","Username": obj["Account"]["Username"],"Password": obj["Account"]["Password"],"Totp": ""})
